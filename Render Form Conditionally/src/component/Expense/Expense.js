...
function Expense(props) {
  ...
  {
   expensezero=<p className="fs-5 text-light bg-dark text-center border rounded py-1">No Expenses Found.</p>
  }
  let oneExpense;
  ...
  return (
    <div class="container my-4">
      ...
      <div  className="border p-2 rounded shadow p-3 mb-5 bg-body rounded">
      <ExpenseFilter
