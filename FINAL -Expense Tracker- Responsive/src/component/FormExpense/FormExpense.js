...
function FormExpense(props) {
  ...
  return (
    ...
    <form onSubmit={submitHandler} className="border p-2 rounded shadow p-3 mb-5 bg-body rounded">
      ...
      <div className="form-group my-3 d-flex justify-content-end">
        <button className='btn btn-primary my-4' type="submit">Add expense</button>
        <button className='btn btn-primary my-4 mx-2' type="button" onClick={props.onCancel} >Cancel</button>
