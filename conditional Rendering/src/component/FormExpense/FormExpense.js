...
function FormExpense(props) {
  ...
  return (
    ...
    <form onSubmit={submitHandler} className="border border-secondary p-2 rounded shadow p-3 mb-5 bg-body rounded">
      ...
      <div className="form-group my-3">
        <button className='btn btn-primary my-4'>Add expense</button>
